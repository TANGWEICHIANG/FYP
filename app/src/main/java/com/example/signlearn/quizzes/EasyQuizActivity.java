...
public class EasyQuizActivity extends AppCompatActivity {
    ...
    private static final long EASY_MODE_TIME = 300000; // 300 seconds
    ...
    private void loadQuestions() {
        ...
        try {
            ...
            InputStream inputStream = res.openRawResource(R.raw.easy_question);
            ...
            Toast.makeText(EasyQuizActivity.this, "Error loading questions.", Toast.LENGTH_SHORT).show();
        }
    }

    private void startQuiz() {
        timeLeftInMillis = EASY_MODE_TIME;
        startTimer();
        loadNextQuestion();
    }
    ...
    private void checkAnswer(String selectedAnswer) {
        try {
            ...
            if (selectedAnswer.equals(correctAnswer)) {
                score++;
                Toast.makeText(EasyQuizActivity.this, "Correct!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(EasyQuizActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
            }
    ...
    private void endQuiz() {
        ...
        Toast.makeText(EasyQuizActivity.this, "Quiz Finished! Your score: " + score, Toast.LENGTH_LONG).show();
